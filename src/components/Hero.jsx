...
import './Hero.css';
import profilePhoto from '../assets/images/saya.png';
      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Building scalable software and robust web applications. Passionate
            about clean code, modern architectures, and delivering seamless user experiences.
          </p>
          ...
          <div className="hero-image-inner">
            ...
            <div className="hero-social">
              <a
                ...
                className="social-link github" aria-label="GitHub"
              >
