                ...
                <div className="about-grid">
                    ...
                    <div className="about-content">
                        ...
                        <div className="about-text">
                            ...
                            <p>
                                Ketertarikan saya bermula dari rasa ingin tahu terhadap cara data diolah menjadi informasi yang bermakna. Seiring berjalannya waktu, saya semakin terdorong untuk memperdalam kemampuan di bidang AI. Saat ini, saya fokus mengembangkan skill dasar hingga menengah dalam Machine Learning, serta mulai mempelajari area seperti Deep Learning, Natural Language Processing, dan Computer Vision sebagai bagian dari proses bertumbuh dan eksplorasi saya di dunia AI.
                            </p>
                        </div>
